...
from apps.users.views.vehicle_management import VehicleUpdateView, VehicleDeleteView
urlpatterns = [
    ...
    path('delete-vehicle/<int:id>/', VehicleDeleteView.as_view(), name='delete-vehicle'),
]